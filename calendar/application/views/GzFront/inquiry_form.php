    ...
    <form id="webform-client-form" class="webform-client-form webform-client-form-1083" action="/bali-individually/villas/verve-villa-lombok" method="post" accept-charset="UTF-8">
        <div class="form-title visible-lg visible-md">
            <h2 class="text-center">
                <span class="nowrapper"><?php echo $tpl['calendar']['i18n'][$tpl['select_language']['id']]['title']; ?></span>
            </h2>
        </div>
        <div class="row form-group">
            ...
            ?>
            <div class="col-xs-12">
                <select id="currencies-value-id" class="form-select input-sm form-control hidden" name="currencies" tabindex="-1" aria-hidden="true">
                    <?php
        ...
        <div class="row meta form-group">
            ...
            <div id="total" class="price center"></div>
            <!--modified: add new-->
            <div id="total-with-tax" class="price center"></div>
        </div>
        <?php
        $date_fomrat = Util::getJsDateFormat($tpl['option_arr_values']['date_format']);
        ?>
        <div class="form-group input-group groupdate">
            <input data-format="<?php echo $date_fomrat; ?>" id="startdate" class="start-date-calendar required input-sm form-control" required="required" placeholder="start date" name="startdate" value="" size="60" maxlength="128" type="text">
            <span class="input-group-addon date-to">to</span>
            <input data-format="<?php echo $date_fomrat; ?>" id="finishdate" class="end-date-calendar required input-sm form-control" required="required" placeholder="end date" name="finishdate" value="" size="60" maxlength="128" type="text">
        </div>
        <div class="row form-group">
            <div class="col-xs-12">
