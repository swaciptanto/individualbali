...
<div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
        ...
        <li class="">
            <a data-toggle="tab" href="#emails_tab_3"><?php echo __('owner_emails'); ?></a>
        </li>
    </ul>    
            ...
            foreach ($tpl['emails']['client'] as $option) {
                if ($option['type'] == 'string') {
                    ...
                    <div class="form-group">
                        ...
                        <input id="<?php echo $option['key']; ?>" class="form-control input-sm" type="text" name="<?php echo $option['key'] ?>" size="25" value="<?php echo htmlspecialchars($option['value']); ?>" title="Title" placeholder="title">
