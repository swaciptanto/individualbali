<section class="content-header">
    <h1>
        <?php echo __('amount_statistic'); ?>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo INSTALL_URL; ?>"><i class="fa fa-dashboard"></i> <?php echo __('home'); ?></a></li>
        <li class="active"><?php echo __('amount_statistic'); ?></li>
    </ol>
</section>
<section class="content left width_100">
    <form id="statistic_booking_id" class="frm-class" action="<?php echo INSTALL_URL; ?>GzStatistic/amount" method="post" name="filter_statistic">
    ...
    <div class="box box-info left">
        <div class="box-header">
            <h3 class="box-title"><?php echo __('amount_statistic'); ?></h3>
        </div>
...
foreach ($tpl['month_chart'] as $k => $v) {
    ?>
                {month: '<?php echo $k ?>', amount: <?php echo (!empty($v['total'])) ? $v['total'] : 0; ?>},
    <?php
}
?>
        ],
