<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo INSTALL_URL; ?>GzExtra/index"><?php echo __('extras'); ?></a></li>
...
<fieldset class="requiresjcrop" style="margin: .5em 0;">
    ...
    <div class="btn-group">
        <?php if (is_file(INSTALL_PATH . UPLOAD_PATH . "extra/thumb/" . $tpl['arr']['img'])) { ?>
...
<fieldset class="form-actions">
    <?php
    if (is_file(INSTALL_PATH . UPLOAD_PATH . "extra/thumb/" . $tpl['arr']['img'])) {
        $type = 'preview';
        ?>
        <img src='<?php echo INSTALL_URL . UPLOAD_PATH . "extra/thumb/" . $tpl['arr']['img']; ?>' id="cropbox" >
        <?php }
    ?>
...
<fieldset>
    <form action="<?php echo INSTALL_URL; ?>/GzExtra/cropImage/<?php echo $tpl['arr']['id']; ?>" method="post" >
        <fieldset class="form-actions">
            ...
            <input type="hidden" name="controller" value="GzExtra" /> 
    ...
    (function($) {
        $(function() {
            ...
            $('#img1').click(function(e) {
                ...
                jcrop_api.setImage('<?php echo UPLOAD_PATH . "extra/thumb/" . $tpl['arr']['img']; ?>');
