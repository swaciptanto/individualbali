...
include_once FRAMEWORK_PATH . 'BaseQueryDrupal.php';
include_once FRAMEWORK_PATH . 'CommonQueryDrupal.php';
include_once FRAMEWORK_PATH . 'SelectQueryDrupal.php';
...
class ModelDrupal extends Object {
    ...
    function __construct(FluentStructure $structure = null) {
        ...
        if (defined('DRUPAL_DB')) {
            $this->setDatabase(DRUPAL_DB);
        }
        if (defined('DRUPAL_HOST')) {
            $this->setHost(DRUPAL_HOST);
        }
        if (defined('DRUPAL_USER')) {
            $this->setUser(DRUPAL_USER);
        }
        if (defined('DRUPAL_PASS')) {
            $this->setPass(DRUPAL_PASS);
        }
    ...
    public function from($table, $primaryKey = null) {
        $query = new SelectQueryDrupal($this, $table);
        if ($primaryKey) {
